     ...
     <td style="vertical-align: top; width:500px">
       <p style="padding-bottom:15px"> Specifies the compression method applied to the pixel data of all
         ...
         <ul>
           ...
           <li> <tt> HT_COMPRESSION </tt> - JPEG 2000 lossless coding, in blocks of 256 scanlines and using the High-Throughput (HT) blocker. Offers both speed and high-coding efficiency. </li>
         </ul>
       </p>
     </td>
   </tr>
