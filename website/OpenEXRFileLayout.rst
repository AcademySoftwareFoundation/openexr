...
|00         |0                    |INCY value  |
+-----------+---------------------+------------+
|70         |pixelAspectRatio\\0  |attribute   |
+-----------+                     |name        |
|69         |                     |            |
+-----------+                     |            |
|78         |                     |            |
...
|3f         |                     |            |
+-----------+---------------------+------------+
|73         |screenWindowCenter\\0|attribute   |
+-----------+                     |name        |
|63         |                     |            |
+-----------+                     |            |
|72         |                     |            |
...
|00         |                     |            |
+-----------+---------------------+------------+
|73         |screenWindowWidth\\0 |attribute   |
+-----------+                     |name        |
|63         |                     |            |
+-----------+                     |            |
|72         |                     |            |
