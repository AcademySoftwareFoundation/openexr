...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /I "../../../IlmImf" /I "../../../Iex" /I "../../../Imath" /I "../../../IlmImfTest" /I "../../../Half" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "PLATFORM_WIN32" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 zlib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /entry:"mainCRTStartup" /subsystem:console /machine:I386 /libpath:"..\..\..\zlib\lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy ..\..\..\IlmImfTest\*.exr .	Release\IlmImfTest.exe	del *.exr
...
# ADD CPP /nologo /MTd /W3 /Gm /GR /GX /ZI /Od /I "../../../IlmImf" /I "../../../Iex" /I "../../../Imath" /I "../../../IlmImfTest" /I "../../../Half" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "PLATFORM_WIN32" /FD /GZ /c
# SUBTRACT CPP /YX
...
# ADD LINK32 zlib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /entry:"mainCRTStartup" /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"..\..\..\..\zlib\lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Desc=Running IlmImfTest program...
PostBuild_Cmds=copy ..\..\..\IlmImfTest\*.exr .	Debug\IlmImfTest.exe	del *.exr
# End Special Build Tool
