...
define([arg_pkg_name],$3)
define([arg_include_subdir],$4)
define([arg_default_libs],$5)
define([arg_test_prefix],$6)
...
if test "x$test_prefix" != "xNONE" ; then
   ...
   if test x$PKG_CONFIG != xno ; then
      ...
      TEST_LDFLAGS="`$PKG_CONFIG --libs arg_pkg_name`"
   else
      TEST_CXXFLAGS=""
      TEST_LDFLAGS=""
   ...
   dnl
   dnl if the flags are still not set, try a prefix an finally a default
   dnl
