                    ...
                    switch (encc->user_data_type)
                    {
                        case EXR_PIXEL_HALF: {
                            ...
                            for (int x = 0; x < w; ++x)
                            {
                                ...
                                *dst++ = one_from_native32 (half_to_uint (tmp));
                                cdata += pixincrement;
                            }
                            break;
                        }
                        case EXR_PIXEL_FLOAT: {
                            ...
                            for (int x = 0; x < w; ++x)
                            {
                                ...
                                *dst++ =
                                    one_from_native32 (float_to_uint (tmp));
                                cdata += pixincrement;
                            }
                            break;
                        }
