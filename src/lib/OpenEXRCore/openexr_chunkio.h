...
EXR_EXPORT
exr_result_t exr_part_read_scanline_block_info (
...
EXR_EXPORT
exr_result_t exr_part_read_tile_block_info (
    const exr_context_t     ctxt,
    int                     part_index,
    int                     tilex,
    int                     tiley,
 ...
 */
EXR_EXPORT
exr_result_t exr_part_read_chunk (
    const exr_context_t           ctxt,
    int                           part_index,
 ...
 * @sa exr_part_read_chunk also works to read deep data packed data,
 ...
 */
EXR_EXPORT
exr_result_t exr_part_read_deep_chunk (
    const exr_context_t           ctxt,
    int                           part_index,
    const exr_chunk_block_info_t* cinfo,
    void*                         packed_data,
...
EXR_EXPORT
exr_result_t exr_part_write_scanline_chunk (
    exr_context_t ctxt,
    int           part_index,
    int           y,
...
/** y must the appropriate starting y for the specified chunk */
EXR_EXPORT
exr_result_t exr_part_write_deep_scanline_chunk (
    exr_context_t ctxt,
    int           part_index,
    int           y,
    const void*   packed_data,
...
EXR_EXPORT
exr_result_t exr_part_write_tile_chunk (
    exr_context_t ctxt,
    int           part_index,
    int           tilex,
    int           tiley,
...
EXR_EXPORT
exr_result_t exr_part_write_deep_tile_chunk (
    exr_context_t ctxt,
    int           part_index,
    int           tilex,
    int           tiley,
