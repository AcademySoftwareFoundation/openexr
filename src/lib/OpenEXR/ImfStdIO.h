...
class IMF_EXPORT_TYPE StdIFStream
    : public OPENEXR_IMF_INTERNAL_NAMESPACE::IStream
{
public:
    //-------------------------------------------------------
...
class IMF_EXPORT_TYPE StdISStream
    : public OPENEXR_IMF_INTERNAL_NAMESPACE::IStream
{
public:
...
class IMF_EXPORT_TYPE StdOFStream
    : public OPENEXR_IMF_INTERNAL_NAMESPACE::OStream
{
public:
    //-------------------------------------------------------
    // A constructor that opens the file with the given name.
...
class IMF_EXPORT_TYPE StdOSStream
    : public OPENEXR_IMF_INTERNAL_NAMESPACE::OStream
{
public:
