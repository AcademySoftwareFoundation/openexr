...
IMF_STD_ATTRIBUTE_IMP (creator, Creator, string)
...
IMF_STD_ATTRIBUTE_IMP (cameraIdentifier, CameraIdentifier, string)
...
IMF_STD_ATTRIBUTE_IMP (lensAttributes, LensAttributes, string)
...
IMF_STD_ATTRIBUTE_IMP (recorderMake, RecorderMake, string)
IMF_STD_ATTRIBUTE_IMP (recorderModel, RecorderModel, string)
IMF_STD_ATTRIBUTE_IMP (recorderSerialNumber, RecorderSerialNumber, string)
IMF_STD_ATTRIBUTE_IMP (recorderFirmwareVersion, RecorderFirmwareVersion, string)
IMF_STD_ATTRIBUTE_IMP (storageMediaSerialNumber, StorageMediaSerialNumber, string)
IMF_STD_ATTRIBUTE_IMP (reelName, ReelName, string)
IMF_STD_ATTRIBUTE_IMP (uuid, Uuid, string)
...
IMF_STD_ATTRIBUTE_IMP (cameraPosition, CameraPosition, V3f)
IMF_STD_ATTRIBUTE_IMP (cameraUpDirection, CameraUpDirection, V3f)
IMF_STD_ATTRIBUTE_IMP (cameraViewingDirection, CameraViewingDirection, V3f)
