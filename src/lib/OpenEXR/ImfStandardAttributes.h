...
// chromaticities, whiteLuminance, adoptedNeutral and acesImageContainerFlag
// that leave a part's color space ambiguous or self-contradictory.
//
// None of these make a file malformed or unsafe to read, which is why this
// is separate from the file validation in ImfCheckFile.h: they are
// warnings about the meaning of the metadata, not errors.
//
// A header with neither colorInteropID nor acesImageContainerFlag makes no
// claim about its color space, and so never produces a warning.
//
