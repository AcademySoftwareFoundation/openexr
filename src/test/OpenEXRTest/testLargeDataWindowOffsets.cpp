...
static const long long maxMem =
    16ll * 1024ll *
    1024ll; // max memory usage for pixel storage should be 16 MiB
static const long long maxMemoryPerBuffer =
    maxMem / 2ll; // read and write buffers are separate
static const long long pixelCount =
    maxMemoryPerBuffer / (long long) (10 * sizeof (float));
...
static const PixelType allFloats[] = {
    FLOAT,
    FLOAT,
    FLOAT,
    FLOAT,
...
static const PixelType halfFloat[] = {
    ...
    HALF,
    FLOAT};
static const PixelType floatHalf[] = {
    FLOAT,
    HALF,
    FLOAT,
    HALF,
