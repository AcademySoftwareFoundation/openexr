...
IF ( ILMBASE2_LOCATION )
  ...
  ELSE (Ilmbase2_USE_STATIC_LIBS)
    IF (WIN32)
      FIND_LIBRARY_EX ( Ilmbase2_HALF_LIBRARY Half ${ILMBASE2_LOCATION}/lib ".dll")
      FIND_LIBRARY_EX ( Ilmbase2_IEX_LIBRARY Iex-2_1 ${ILMBASE2_LOCATION}/lib ".dll")
      FIND_LIBRARY_EX ( Ilmbase2_IEXMATH_LIBRARY IexMath-2_1 ${ILMBASE2_LOCATION}/lib ".dll")
      FIND_LIBRARY_EX ( Ilmbase2_IMATH_LIBRARY Imath-2_1 ${ILMBASE2_LOCATION}/lib ".dll")
    ELSEIF (APPLE)
