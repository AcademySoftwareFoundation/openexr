...
IF ( ILMBASE2_LOCATION )
  ...
  ELSE (Ilmbase2_USE_STATIC_LIBS)
    ...
    ELSE (WIN32)
      ...
      FIND_LIBRARY_EX ( Ilmbase2_IEX_LIBRARY Iex ${ILMBASE2_LOCATION}/lib ".so")
      FIND_LIBRARY_EX ( Ilmbase2_IEXMATH_LIBRARY IexMath ${ILMBASE2_LOCATION}/lib ".so")
      FIND_LIBRARY_EX ( Ilmbase2_IMATH_LIBRARY Imath ${ILMBASE2_LOCATION}/lib ".so")
    ENDIF(WIN32)
  ENDIF ()
